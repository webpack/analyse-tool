...
export default {
  ...
  'homePage.button.clickMe': 'Click me (log)',
  'homePage.para.pressCtrlH': 'Press <code>ctrl-h</code> to toggle Redux Dev Tools (development build only).',
  'homePage.para.autoUpdate': 'This pages auto-updates when you make changes and save.',
  'homePage.para.es7Decorator': `This page also demonstrates the use of the
